...
?>
      ...
      <div role="main" class="main block-shadow-02">
        ...
        <!-- <section id="section-testimonials" hidden style="display:none;">
          <div class="container">
            <h2><span class="text-color-01">Happy Clients</span> <span class="block-ws-nowrap">About Us</span></h2>
            <div class="testimonials-wrap testimonials-carousel">
              <div class="tw-item-wrap">
                <div class="tw-item">
                  <div class="tw-header bg-gradient-02 d-flex align-items-center">
                    <div class="col-auto tw-img" style="background-image: url(img/t-01.png)"></div>
                    <div>
                      <p class="tw-author">Leah Reeder</p>
                      <p class="tw-author-info">
                        <svg class="icon icon-star-five"><use xlink:href="css/fonts/icons.svg#star-five"></use></svg>
                        <span class="tw-author-info-additional">5.0</span>
                      </p>
                    </div>
                  </div>
                  <div class="tw-body">
                    <p>Carl and Miranda from CPS educated me by being open and transparent with how the industry operates and in turn saved me a lot of money compared to our previous provider (even though both companies processed through first data). Their level of customer service and support is exemplary and we can call them anytime with questions. They’ll even bring coffee!</p>
                  </div>
                </div>
              </div>
              ...
              <div class="tw-item-wrap">
                <div class="tw-item">
                  <div class="tw-header bg-gradient-03 d-flex align-items-center">
                    <div class="col-auto tw-img" style="background-image: url(img/t-02.png)"></div>
                    <div>
                      <p class="tw-author">Mohammad Osama</p>
                      <p class="tw-author-info"><svg class="icon icon-star-five"><use xlink:href="css/fonts/icons.svg#star-five"></use></svg></p>
                    </div>
                  </div>
                  <div class="tw-body">
                    <p>The lowest rate was secured with this company after long search and shopping arround. I signed up my both businesses since two years and over the time found out that I made an excellent choice.. never had a problem in the service, got an excellent instant response whenver we call. Got a phenomenal machine Clover recently that has mutiple functions and works on multiple communication lines!! It is litrally a smart debit machine that really adds value to my business. Recomended to all</p>
                  </div>
                </div>
              </div>
              ...
              <div class="tw-item-wrap">
                <div class="tw-item">
                  <div class="tw-header bg-gradient-04 d-flex align-items-center">
                    <div class="col-auto tw-img" style="background-image: url(img/t-03.png)"></div>
                    <div>
                      <p class="tw-author">Kasandra Bois</p>
                      <p class="tw-author-info"><svg class="icon icon-star-five"><use xlink:href="css/fonts/icons.svg#star-five"></use></svg></p>
                    </div>
                  </div>
                  <div class="tw-body">
                    <p>I’ve had nothing but an amazing experience. Everything was easily done and was easy to put together. I’ve had no issues what so ever and you can beat the rates. Just amazing</p>
                  </div>
                </div>
              </div>
              ...
              <div class="tw-item-wrap">
                <div class="tw-item">
                  <div class="tw-header bg-gradient-04 d-flex align-items-center">
                    <div class="col-auto tw-img" style="background-image: url(img/t-04.png)"></div>
                    <div>
                      <p class="tw-author">Stacey Thornton</p>
                      <p class="tw-author-info"><svg class="icon icon-star-five"><use xlink:href="css/fonts/icons.svg#star-five"></use></svg></p>
                    </div>
                  </div>
                  <div class="tw-body">
                    <p>Amazing and knowledgeable company! <br>Highly recommend!</p>
                  </div>
                </div>
              </div>
              ...
              <div class="tw-item-wrap">
                <div class="tw-item">
                  <div class="tw-header bg-gradient-02 d-flex align-items-center">
                    <div class="col-auto tw-img" style="background-image: url(img/t-man.png)"></div>
                    <div>
                      <p class="tw-author">B. Meech</p>
                      <p class="tw-author-info"><svg class="icon icon-star-five"><use xlink:href="css/fonts/icons.svg#star-five"></use></svg></p>
                    </div>
                  </div>
                  <div class="tw-body">
                    <p>I did some business with CPS for a while now. Very good company. One of the most competent ISO's out there. The staff is very prompt and reliable, the rates were good &  I was able to save a decent amount of money. Being in Quebec it was nice to have some french speaking people on the phone from Montreal</p>
                  </div>
                </div>
              </div>
            </div>
