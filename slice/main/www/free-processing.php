...
$view->page_start(array('title' => "Free Processing | Slice"));
?>
      ...
      <div role="main" class="main main-appear" id="main-appear">
        ...
        <section class="section-page-hero bg-header-overlay section-appear" id="section-appear">
          ...
          <div class="container">
            <div class="sph-info">
              <h1 class="header-lg">Free <br>Processing</h1>
              <p class="block-mb-lg"><a href="#contact-form" data-popup-open class="link-angle">Learn More</a></p>
        ...
        <section class="block-pb-md">
          <div class="container">
            <div class="text-center block-mb-md">
              ...
              <p class="sub-header sub-header-sm">With recent law changes and the advancement of our proprietary software your business can accept credit cards for FREE! Slice Introduces Zero Fee Credit Card Processing!</p>
            </div>
            ...
            <div class="highlight-bordered-info">
              <div class="row no-gutters align-items-center">
                <div class="col-auto hbi-xlg">2</div>
                <div class="col-auto hbi-header">Zero Fee processing <br>Programs</div>
                <div class="col-12 col-lg hbi-desc">More and more businesses are taking advantage of Slice 0% Programs everyday. Use the savings to grow your business by spending money where it matters. <br>We offer 2 ZERO FEE processing programs for your business. <a href="#contact-form" data-popup-open>Contact us now</a> to see which one is the best fit for your business.</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="section-info-tile-decor block-pb-zero">
            ...
            <div class="container">
              <div class="row align-items-lg-center">
                <div class="col-md-7 block-zi-2 order-2 order-md-1 block-indent-right-lg">
                  ...
                  <p class="sub-header sub-header-sm">The Slice Cash Discount Program is a way for you the merchant to offset your merchant service fees without increasing your sale price. It is a method of passing a service fee to all customers while giving a discount to those who pay with cash.</p>
                  <ul class="list-circle block-mb-sm">
                    <li>100% legal</li>
                    <li>Available in all 50 states</li>
                    <li>Collect 100% of your processing sales</li>
                    <li>Eliminate monthly processor fees</li>
                    <li>incredibly easy to order, set up and manage</li>
                    <li>Next day funding</li>
                  </ul>
                  <div class="btn-group">
                    <a href="#contact-form" data-popup-open class="btn btn-img"><svg class="svg-inline-icon"><use xlink:href="#svg-brand"></use></svg>Talk to an expert</a><br>
              ...
              <div class="tile-icon-info block-zi-2">
                <div class="row">
                  <div class="col-12 col-lg-auto tii-cta">
                    ...
                    <a href="#contact-form" data-popup-open class="link-angle">Get Started</a>
                  </div>
                  <div class="col">
                    <div class="row">
                      <div class="col-sm-3 tii-item">
                        ...
                        <p>With our software, all the processing fees will be incorporated into the sale and a small service fee is passed on to the card holder.</p>
                      </div>
                      <div class="col-sm-3 tii-item">
          ...
          <div class="sitd-item bg-light-grey anchor-wrap">
            <div class="anchor-block" id="credit-surcharge"></div>
            <div class="container">
              <div class="row align-items-lg-center">
                <div class="col-md-5">
                  <div class="tile-decor-wrap tile-decor-wrap-left">
                    <div class="tile-decor-substrate-wrap tdsw-02 tile-decor-substrate-anim"><div></div></div>
                    <div class="tile-decor bg-v-gradient-blue">
                      <div class="tile-decor-content">
                        <div class="tile-decor-icon"><svg class="icon icon-credit-card-check"><use xlink:href="css/fonts/icons.svg#credit-card-check"></use></svg></div>
                        <p class="tile-decor-header">Slice <br>Credit Surcharge <br>Program</p>
                        <p class="tile-decor-desc">Any business that accepts credit cards can benefit from Slice</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-7 block-zi-2 block-indent-left-lg">
                  <h2 class="h1">Credit Surcharge</h2>
                  <p class="sub-header sub-header-sm">The Slice Cash Discount Program is a way for you the merchant to offset your merchant service fees without increasing your sale price. It is a method of surcharging a customer who is paying with a credit card.</p>
                  <ul class="list-circle block-mb-sm">
                    <li>Legal in 42 states</li>
                    <li>Collect 100% of credit card processing sales</li>
                    <li>Eliminate monthly processor fees</li>
                    <li>incredibly easy to order, set up and manage</li>
                    <li>Next day funding</li>
                  </ul>
                  <div class="btn-group">
                    <a href="#contact-form" data-popup-open class="btn btn-img"><svg class="svg-inline-icon"><use xlink:href="#svg-brand"></use></svg>Talk to an expert</a><br>
                    <a href="faq" class="link-angle link-grey">Learn more</a>
                  </div>
                </div>
              </div>

              <div class="tile-icon-info tile-icon-info-01 block-zi-2">
                <div class="row">
                  <div class="col-12 col-lg-auto tii-cta">
                    <p class="tii-cta-header">How <br>Credit Surcharge <br>works?</p>
                    <a href="#contact-form" data-popup-open class="link-angle">Get Started</a>
                  </div>
                  <div class="col">
                    <div class="row">
                      <div class="col-sm-4 tii-item">
                        <div class="tii-item-icon"><svg class="icon icon-colored-support-speak"><use xlink:href="css/fonts/icons.svg#colored-support-speak"></use></svg></div>
                        <p class="tii-item-header">Speak to our Rep</p>
                        <p>Our experienced professionals are standing by to answer any questions you may have about the Surcharge Program.</p>
                      </div>

                      <div class="col-sm-4 tii-item">
                        <div class="tii-item-icon"><svg class="icon icon-colored-payment"><use xlink:href="css/fonts/icons.svg#colored-payment"></use></svg></div>
                        <p class="tii-item-header">Upgrade a terminal</p>
                        <p>Everything is automated. The terminal will automatically prompt a surcharge of 3.99% on credit card transactions at the time of the sale.</p>
                      </div>

                      <div class="col-sm-4 tii-item">
                        <div class="tii-item-icon"><svg class="icon icon-colored-piggy-bank"><use xlink:href="css/fonts/icons.svg#colored-piggy-bank"></use></svg></div>
                        <p class="tii-item-header">Start saving</p>
