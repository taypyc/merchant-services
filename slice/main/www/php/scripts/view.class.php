...
EOD;
  ...
  public function display_title() {
    ...
    } else if($this->page == 'partners') {
      $partners = ' class="active"';
    } else if($this->page == 'support') {
      $resources = ' class="active"';
    }

    $header_appear_pages = array('index', 'free-processing', 'equipment', 'capital', 'partners', 'support', 'faq', 'contact-us', 'about', 'standalone-terminals', 'privacy-policy', 'sitemap', 'error', 'state-regulations');
    $header_light_pages = array('partners', 'support', 'faq', 'contact-us', 'about', 'privacy-policy', 'sitemap', 'error', 'state-regulations', 'careers-regional-sales-agent');
                ...
                <div class="header-nav">
                  <nav>
                    <ul class="hn-menu row align-items-center no-gutters">
                      <li{$free_processing}><a href="{$this->site_root}free-processing"><span>Free Processing</span></a></li>
                      ...
                      <li{$partners}><a href="{$this->site_root}partners"><span>Partners</span></a></li>
          ...
          <div class="row flex-lg-nowrap">
            <div class="col-12 col-lg-auto footer-info-wrap d-flex flex-column">
              ...
              <div class="footer-desc">
                <p>Slice Business Marketing Inc. is an agent of Merchant Services LLC  a registered ISO of Wells Fargo Bank N.A., Walnut Creek, CA</p>
            ...
            <div class="col-12 col-lg-auto ml-auto footer-links-wrap">
              ...
              <div class="row footer-links justify-content-between justify-content-lg-end flex-sm-nowrap">
                ...
                <div class="col-12 col-sm-auto fl-item">
                  <h6>Services</h6>
                  <ul>
                    <li><a href="{$this->site_root}free-processing#cash-discount">Cash Discount</a></li>
                    <li><a href="{$this->site_root}free-processing#credit-surcharge">Credit Surcharge</a></li>
                    <li><a href="{$this->site_root}free-processing#traditional-processing">Traditional Processing</a></li>
                ...
                <div class="col-12 col-sm-auto fl-item">
                  ...
                  <ul>
                    ...
                    <li><a href="{$this->site_root}equipment">Clover<sup>TM</sup> POS Family</a></li>
      ...
      'clover-pos' => '
                  <div class="col-4">
                    <a href="' . $this->i['signup_url'] . '" class="tile-service-sm bg-diagonal-turquoise">
                      ...
                      <span class="tile-service-sm-cta font-header"><span class="link-grey">Clover<sup>TM</sup> POS <br>Family</span></span>
                    </a>
                  </div>',
      'slice-pos' => '
                  <div class="col-4">
                    <a href="' . $this->i['signup_url'] . '" class="tile-service-sm bg-diagonal-violet">
                      <span class="tile-service-sm-img"><img src="img/service-slice-pos.png" alt=""></span>
                      <span class="tile-service-sm-cta font-header"><span class="link-grey">Slice POS</span></span>
                    </a>
                  </div>',
      'aldelo-pos' => '
                  <div class="col-4">
