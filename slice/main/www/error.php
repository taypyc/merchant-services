...
$redirect_after_delay = <<<EOD
      <script>
        setTimeout(function () {
          window.location.href = "{$view->site_root}";
        }, 15000);
      </script>
EOD;
$view->page_start(array('title' => 'Slice | Page not found | 404', 'headers' => array('404' => true)));
?>
                    ...
                    <div class="tile-info-links d-flex flex-column">
                      ...
                      <div class="til-links mt-auto">
                        <ul>
                          ...
                          <li><a href="faq/credit-surcharge" class="link-angle link-violet">Credit Surcharge FAQ</a></li>
