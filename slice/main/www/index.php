            ...
            <div class="hero-wrap d-flex align-items-center">
              <div class="hero-wrap-content">
                ...
                <div class="hwc-info">
                  ...
                  <h1>100% Free <span class="header-modification">Credit Card Processing</span></h1>
                  <p class="sub-header block-mb-md">Slice 100% of Processing Fees by <span class="white-space-nw">Rewarding Cash Payers</span></p>
                  <div class="btn-group">
                    <a href="#contact-form" data-popup-open class="btn">Get Started</a>
            ...
            <div class="row">
              ...
              <div class="col-auto svp-list-wrap">
                <ul class="list-icon-header lih-01">
                  <li>
                    <div class="additional-info"><div class="additional-info-xl">0%</div><div class="additional-info-sm">Processing Fee</div></div>
                    ...
                    <p class="lih-desc">It is a method of passing a service fee to all customers while giving a discount to those who pay with cash.</p>
                    <a href="free-processing#cash-discount" class="link-angle">Learn More</a>
                  </li>
                  <li>
                    <div class="additional-info"><div class="additional-info-xl">0%</div><div class="additional-info-sm">Processing Fee</div></div>
                    <div class="lih-icon"><svg class="icon icon-credit-card-check"><use xlink:href="css/fonts/icons.svg#credit-card-check"></use></svg></div>
                    <p class="lih-header">Credit Surcharge</p>
                    <p class="lih-desc">A surcharge is an additional fee that a merchant adds to a consumer’s bill when he or she uses a credit card for payment.</p>
                    <a href="free-processing#credit-surcharge" class="link-angle">Learn More</a>
                  </li>
                  <li>
              ...
              <div class="row">
                ...
                <div class="col-6 tsw-item">
                  <div class="tile-service tile-service-left">
                    <a href="#contact-form" data-popup-open class="tile-service-link bg-diagonal-turquoise">
                    ...
                    <div class="tile-service-info">
                      <div class="tsi-container">
                        <h5>Clover<sup>TM</sup> POS Family</h5>
                ...
                <div class="col-6 ml-auto tsw-item">
                  <div class="tile-service tile-service-right">
                    <a href="#contact-form" data-popup-open class="tile-service-link bg-diagonal-violet">
                      <span class="tile-service-link-wrap"><span class="tile-service-link-img"><img class="tile-service-img" src="img/service-slice-pos.png" alt=""></span></span>
                      <span class="tile-service-cta"><span class="link-angle link-grey">Learn More</span></span>
                    </a>
                    <div class="tile-service-info">
                      <div class="tsi-container">
                        <h5>Slice POS</h5>
                        <p>Our All-In-One POS is easy to use and cross-platform</p>
                        <ul class="list-checked">
                          <li>Any type of small business</li>
                          <li>Quick-Service Restaurants</li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="col-6 tsw-item">
                  <div class="tile-service tile-service-left">
                    <a href="#contact-form" data-popup-open class="tile-service-link bg-diagonal-mint">
                ...
                <div class="col-6 ml-auto tsw-item">
                  <div class="tile-service tile-service-right">
                    <a href="#contact-form" data-popup-open class="tile-service-link bg-diagonal-orange-bright">
                ...
                <div class="w-100"></div>
                <div class="col-12 col-sm-6 tsw-cta tsw-cta-left">
                    ...
                    <div class="row tci-container align-items-center">
                      <div class="col-12">
                        ...
                        <div class="tci-cta text-center">
                          <a href="#contact-form" data-popup-open class="btn btn-lg">Get Started</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-12 col-sm-4">
                <a href="#" class="tile-info-img tile-info-img-transparent">
                  <span class="tinim-img" style="background-image: url(img/blog/b-01.jpg)"></span>
                  <span class="tinim-header h5">More merchants adding credit card surcharges</span>
                  <span class="tinim-info text-paragraph">PassThrough technology is one of the best innovations to happen to merchant services in a long...</span>
                  <span class="tinim-cta text-right"><span class="link-angle">Read More</span></span>
                </a>
              </div>
              <div class="col-12 col-sm-4">
                <a href="#" class="tile-info-img tile-info-img-transparent">
                  <span class="tinim-img" style="background-image: url(img/blog/b-02.jpg)"></span>
                  <span class="tinim-header h5">Can Businesses Add A Credit Card Surcharge To Transactions?</span>
                  <span class="tinim-info text-paragraph">PassThrough technology is one of the best innovations to happen to merchant services in a long...</span>
                  <span class="tinim-cta text-right"><span class="link-angle">Read More</span></span>
                </a>
              </div>
              <div class="col-12 col-sm-4">
                <a href="#" class="tile-info-img tile-info-img-transparent">
                  <span class="tinim-img" style="background-image: url(img/blog/b-03.jpg)"></span>
                  <span class="tinim-header h5">5 Reasons Why You Should Consider Using PassThrough</span>
                  <span class="tinim-info text-paragraph">PassThrough technology is one of the best innovations to happen to merchant services in a long...</span>
                  <span class="tinim-cta text-right"><span class="link-angle">Read More</span></span>
                </a>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="cta-wrap">
                ...
                <p class="sub-header font-header">Start using Free Credit Card Processing today!</p>
                ...
                <div class="btn-group">
                  <a href="#contact-form" data-popup-open class="btn">Get Started</a><br>
                  <a href="#contact-form" data-popup-open class="link-angle">Talk To Our Expert Now</a>
                </div>
                <div class="additional-info ai-turquoise"><div class="additional-info-xxl">0%</div><div class="additional-info-md">Processing Fee</div></div>
              </div>
            </div>
          </div>
        </section>
