...
if($target !== false) {
  ...
  } else if($target === 'credit-surcharge') {
    $title = 'Credit Surcharge FAQ';
    $tile = 'credit-surcharge';
    $faq_credit_surcharge = ' class="active"';
                ...
                <div class="row">
                  <div class="col-12 col-md-4 text-center">
                    <ul class="list-links-lg list-links-lg-dib">
                      ...
                      <li><a href="faq/credit-surcharge"<?php echo $faq_credit_surcharge; ?>>Credit Surcharge FAQ</a></li>
                  ...
                  <div class="col-12 col-md-8">
                    <div class="collapse-info-wrap">
                      ...
                      <div class="ciw-item">
                        ...
                        <div class="ciw-item-info"><p>The Slice Cash Discount Program is a way for you the merchant to offset your merchant service fees without increasing your overall rates. It is a method of passing a service fee to all customers while giving a discount to those who pay with cash.</p></div>
                      </div>
                      <div class="ciw-item">
                      ...
                      <div class="ciw-item">
                        ...
                        <div class="ciw-item-info"><p>Recent study states that 80% of consumers wouldn’t think twice about the service fee 39 cents on a $10 purchase for the convenience of using their credit card rather than carrying cash. Everyone has also fell accustomed to the standard $2-$5 ATM fees and whats great is the Slice Cash Discount Program is actually cheaper than those ATM fees. The Slice Cash Discount Program is a way for you the merchant to keep your standards and quality up without having to raise prices, most of your consumers will understand and be ok with it.</p></div>
                      </div>
                      <div class="ciw-item">
                      ...
                      <?php elseif($tile === 'credit-surcharge'): ?>

                      <div class="ciw-item">
                        <div class="ciw-item-toggle">What is a surcharge?</div>
                        <div class="ciw-item-info"><p>A surcharge, also known as a checkout fee, is an additional fee that a merchant adds to a consumer’s bill when he or she uses a credit card for payment.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">It’s too good to be true! How can I accept credit and debit cards at my business without paying high merchant fees?</div>
                        <div class="ciw-item-info"><p>The simplest and quickest way to do so is contact us <span class="white-space-nw"><?php echo $view->i['mobile']; ?></span> and we will provide you with all the necessary tools to start saving money today.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">It is illegal and my bank will shut me down for not paying credit card fees.</div>
                        <div class="ciw-item-info"><p>As a result of a legal settlement to resolve claims brought by a group of U.S. merchants, merchants in the U.S. and U.S. territories may add a surcharge to certain credit card transactions, starting January 27, 2013. Your may choose to choose to surcharge by following all the requirements agreed to as part of the settlement.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">Majority of my customers prefer to pay with cash.</div>
                        <div class="ciw-item-info"><p>There is no surcharge on cash payments. As a business owner, you can offer incentive and encourage your customers to pay by alternative methods.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">I don’t want to surcharge my customers.</div>
                        <div class="ciw-item-info"><p>Most customers are already paying for the convenience of paying higher prices to use cards and even alternative methods of payment. Prime examples are Gas Stations, Municipalities and Education facilities, and ATM’s. These are prime examples of goods and services sold at various businesses going up in price without merchants having to pay for them. Keep the money and use it to expand your business and improve your bottom line!</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">Can’t I surcharge myself?</div>
                        <div class="ciw-item-info"><p>Complex calculations and credit card equipment issues may cause delays and frustration from your customers. Surcharging is also explicitly defined in Visa/Mastercard rules and guidelines, violation of these rules may result in fines and closure of your merchant account.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">I want to let my customers know about the surcharge before they check out. I don’t want them to be caught by surprise.</div>
                        <div class="ciw-item-info"><p>Once enrolled into Credit surcharge program, we will provide you with the signage to be displayed at your business location. <br>We will also provide you with the terminal that displays the surcharge on the receipt.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">Is there a limitation on how much I can surcharge?</div>
                        <div class="ciw-item-info"><p>Retailers must limit the amount of the surcharge to the merchant discount rate for the credit card transaction surcharged, or 4%, whichever is lower.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">Can any business do it?</div>
                        <div class="ciw-item-info"><p>Yes. Any merchant in 42 out of 50 States may elect to surcharge by following all the requirements set by credit card networks. Merchants may not Surcharge if they are located in any one of these 8 States: Colorado, Connecticut, Kansas, Maine, Massachusetts, New York, Oklahoma and Texas</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">What can I surcharge?</div>
                        <div class="ciw-item-info"><p>Surcharging applies only to credit transactions in the U.S. and U.S. territories. Debit and prepaid cannot be surcharged.</p></div>
                      </div>
                      <div class="ciw-item">
                        <div class="ciw-item-toggle">My type of business handles a lot of returns and occasional chargebacks. It sounds very complicated with the surcharge.</div>
                        <div class="ciw-item-info"><p>MerchantSurcharge makes it very simple. On a chargeback or a return the purchase amount plus the surcharge will be credited to the cardholder. Insert the chip as usual and our compliant terminal will do all the work for you.</p></div>
                      </div>
