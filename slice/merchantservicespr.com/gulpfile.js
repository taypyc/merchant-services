...
gulp.task('browser-sync', () => {
  ...
  browserSync.init({
    proxy: 'slice.local/' + projectFolder + siteFolder + '/www/',
    notify: false,
...
gulp.task('deploy', gulp.series('del:deploy', gulp.parallel(gulp.series('css:deploy'), 'img:deploy', 'js:deploy', 'files:deploy')));
