...
class ViewControl {
  ...
  public function display_head($title, $meta_desc = NULL, $meta_keys = NULL) {
    ...
    <!--<script> gtag('event', 'conversion', {'send_to': 'AW-780828836/EHYOCK6Uq5ABEKSBqvQC'}); </script>-->
EOD;
    }
    
    echo <<<EOD
<!DOCTYPE html>
<html{$html_css} lang="es">
  <head>
    <meta charset="utf-8">
    ...
    <!-- Global site tag (gtag.js) - Google Ads: 780828836 --> 
    <!-- <script async src="https://www.googletagmanager.com/gtag/js?id=AW-780828836"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-780828836'); </script> -->
    {$head_js}
          ...
          <div class="header-container container">
            <div class="header-row">
              ...
              <div class="header-column header-nav-wrap">
                <div class="lang-panel"><a href="https://b2bfunding.net/{$lang_page_link}">en</a><a href="https://b2bfunding.net/es/{$lang_page_link}" class="lp-selected">es</a></div>
                ...
                <div class="header-nav">
                  <nav class="spy-nav-menu">
                    <ul class="nav navbar-nav menu-nav">
                      <li><a href="{$index_link}#our-process"{$data_hash}>Nuestro proceso</a></li>
                      <li><a href="{$index_link}#qualify"{$data_hash}>Como se califica</a></li>
                      <li><a href="{$index_link}#funding-programs"{$data_hash}>Programas</a></li>
                      <li><a href="{$index_link}#about-us"{$data_hash}>Sobre nosotros</a></li>
                      <li><a href="{$index_link}#contact-us"{$data_hash}>Contáctenos</a></li>
                    </ul>
                  </nav>
                </div>
              </div>
      ...
      <footer id="footer">
        <div class="container">
          <div class="footer-info-wrap">
            ...
            <div class="fwi-more">
              <div class="fiw-logo"><a href="{$this->site_root}"><img src="img/logo-grey.png" alt="B2B Funding"></a><span>© Copyright 2016 - {$date_year}. <br>All Rights Reserved.</span></div>
              <div class="fiw-links">
                <ul>
  ...
  public function show_contact_tile() {
    ...
    echo <<<EOD
        ...
        <section class="contacts-section" id="contact-us">
          <div class="container">
            <h2 class="header-small">Contáctenos</h2>
            <p class="sub-header">Póngase en contacto</p>
            <div class="map-tile">
                    ...
                    <form class="feedback-form">
                      ...
                      <div class="row">
                        <div class="col-xs-6">
                          <div class="form-group">
                            <input type="text" class="form-control" name="name" required>
                            <span class="m_placeholder">Nombre</span>
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <span class="m_placeholder">Su mensaje</span>
                      </div>
                      <div class="form-group fg-mt">
                        <button type="submit" class="btn" data-loading-text="Processing…">Enviar</button>
                      </div>
                    </form>
                  </div>
                </div>
