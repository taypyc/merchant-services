          ...
          <section class="quality">
              <div class="container">
                  <div class="quality-header">
                      <h2 class="text-center">Will <span class="text-color-blue">My Business</span> Qualify?</h2>
                      <p class="text-center">We focus on the overall health of your business with simple, <br />
                          straight forward requirements. </p>
                  </div>
                  <div class="row align-items-center">
                      ...
                      <div class="col-12 col-lg-6 items">
                          ...
                          <div class="row align-items-center">
                              <div class="col-12 col-lg-7 text-center text-lg-left">
                                  <h6>Time in business</h6>
                                  <p>At least $7,000+ a month deposited <br/ >
                                      in your business bank account</p>
                                  <p></p>
                              </div>
                              <div class="col-12 col-lg-5 text-center text-lg-right">
                                  <div class="big">
