          ...
          <div class="header-container container">
            <div class="header-row">
              ...
              <div class="header-column hc-logo">
                <a href="{$this->site_root}"><img alt="B2B Funding" width="220" height="35" src="{$logo_src}"></a>
              </div>
              
              <div class="header-column header-nav-wrap">
                <div class="lang-panel"><a href="https://b2bfunding.net/{$lang_page_link}" class="lp-selected">en</a><a href="https://b2bfunding.net/es/{$lang_page_link}">es</a></div>
                ...
                <div class="header-nav">
                  <nav class="spy-nav-menu">
                    <ul class="nav navbar-nav menu-nav">
                      <li><a href="{$index_link}#our-process"{$data_hash}>Our Process</a></li>
                      <li><a href="{$index_link}#qualify"{$data_hash}>Do You Qualify</a></li>
                      <li><a href="{$index_link}#funding-programs"{$data_hash}>Funding Programs</a></li>
                      <li><a href="{$index_link}#about-us"{$data_hash}>About Us</a></li>
                      <li><a href="{$index_link}#contact-us"{$data_hash}>Contact Us</a></li>
                    </ul>
                  </nav>
                </div>
              </div>
      ...
      <footer id="footer">
        <div class="container">
          <div class="footer-info-wrap">
            ...
            <div class="fwi-more">
              <div class="fiw-logo"><a href="/"><img src="img/logo-grey.png" alt="B2B Funding"></a><span>© Copyright 2016 - {$date_year}. <br>All Rights Reserved.</span></div>
              <div class="fiw-links">
                <ul>
  ...
  public function show_form_tile() {
    ...
    echo <<<EOD
                ...
                <div class="form-tile{$tile_css}">
                  <h4>Get Pre-Approved for <br>
                  Up to $500,000</h4>
                  <p>Please fill out the form below</p>
                  <form class="contact-form">
                    <div class="form-group">
                      <input type="text" class="form-control" name="name" required>
                      <span class="m_placeholder">Full name</span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <span class="m_placeholder">Phone</span>
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="company" required maxlength="40">
                      <span class="m_placeholder">Company</span>
                    </div>
                    <input type="hidden" name="program" value="Not chosen">
                    <div class="form-group fg-mt">
                      <button type="submit" class="btn" data-loading-text="Processing…">Get started now</button>
                    </div>
                  </form>
                </div>
  ...
  public function show_contact_tile() {
    ...
    echo <<<EOD
        ...
        <section class="contacts-section" id="contact-us">
          <div class="container">
            <h2 class="header-small">Contact Us</h2>
                    ...
                    <form class="feedback-form">
                      <div class="row">
                        <div class="col-xs-6">
                          <div class="form-group">
                            <input type="text" class="form-control" name="name" required>
                            <span class="m_placeholder">Name</span>
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <span class="m_placeholder">Your message</span>
                      </div>
                      <div class="form-group fg-mt">
                        <button type="submit" class="btn" data-loading-text="Processing…">Submit</button>
                      </div>
                    </form>
                  </div>
                </div>
