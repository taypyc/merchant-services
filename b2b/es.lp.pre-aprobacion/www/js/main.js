...
$(function() {
  ...
  var stepsControl = {
    ...
    setHeaderStep: function() {
      ...
      /*if(currentItem == 1) {
        headerSteps.children().eq(currentItem - 1).addClass('completed active-completed');
      } else if(currentItem > 1) {
        setHeaderClasses(currentItem - 1);

        headerSteps.children().eq(currentItem).prevAll().filter(function(index) {
          return $(this).hasClass('active-completed');
        }).removeClass('active-completed');
      } else {
        setHeaderClasses(currentItem);
      }*/

      setHeaderClasses(currentItem);

      function setHeaderClasses(index) {
        headerSteps.children().eq(index).addClass('active').prevAll().filter(function(index) {
  ...
  $('[name="business_name"]').on('keyup focusout', function() {
    $('[name="business_legal_name"]').val($(this).val());
  });
