...
class Markup {
  ...
  public function build_header($settings = []) {
    if(array_key_exists('header_type', $settings) && $settings['header_type'] == 'signup') {
      return $this->get_markup_from_file('markup/markup_07_header_signup.php', $settings);
    }
    return $this->get_markup_from_file('markup/markup_07_header_with_menu.php', $settings);
  }

  public function build_footer($settings = []) {

    return $this->get_markup_from_file('markup/markup_07_footer.php');
  }
  ...
  public function get_form_plaid($continue_signup_data) {
    ...
    $continue_signup_data['flow'] = $this->flow;
    return $this->get_markup_from_file('markup/markup_02_plaid.php', $continue_signup_data);
  }
  ...
  public function build_page($settings) {
    ...
    $markup_name = '';
    $type_to_markup = [
      'thank-you' => 'markup_01_thx_content',
      'privacy-policy' => 'markup_01_privacy_policy',
    ];
