...
foreach($data['services'] as $name_key => $service) {
  ...
  $markup_services .= <<<EOD
              <li data-service="{$name_key}" data-service-url="{$data['site_root']}{$data['page']}/{$name_key}">
                <svg class="icon icon-clover hb-cart-brand"><use xlink:href="{$data['assets_global']}css/fonts/icons.svg#clover"></use></svg>
        ...
        <div class="header-container container">
          <div class="header-body row align-items-center no-gutters<?php echo $header_body_css; ?>">
            <div class="hb-logo col-auto">
              <a href="<?php echo $data['site_root']; ?>"><img src="<?php echo $header_logo; ?>" alt=""></a>
            </div>
            
            <div class="hb-cart col-auto ml-auto">
              <div class="hb-cart-service-selected">
                <span class="hb-cart-01">
                  <svg class="icon icon-clover hb-cart-brand"><use xlink:href="<?php echo $data['assets_global']; ?>css/fonts/icons.svg#clover"></use></svg>
