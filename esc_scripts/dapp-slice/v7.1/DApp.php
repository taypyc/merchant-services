...
class DApp extends DAppService {
  ...
  public function process_ds_completed() {
  ...
  private function set_file_data_array($custom_data_array = []) {
    $additional_data_array = $this->set_additional_data_array($custom_data_array);
    $data = $this->flow_helper->set_file_data_array($additional_data_array);
    return $data;
  }
