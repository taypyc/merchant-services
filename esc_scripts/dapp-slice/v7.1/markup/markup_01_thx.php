...
?>
        ...
        <section class="section-text">
          <div class="container">
            <div class="sh-logo text-center"><img src="<?php echo $this->assets_global; ?>img/logo-01.svg" alt=""></div>
...
?>
        ...
        <section class="section-hero sh-01">
            ...
            <div class="sh-wrap d-flex align-items-center no-gutters">
              <div class="sh-main ml-auto">
                <div class="sh-main-01">
                  <div class="sh-logo"><img src="<?php echo $this->assets_global; ?>img/logo-01.svg" alt=""></div>
                  <h1>Thank you!</h1>
          ...
          <div class="sh-bg sh-bg-01"><img src="<?php echo $this->assets_global; ?>img/intro-clover-flex.jpg" alt=""></div>
          <div class="sh-bottom-info sh-bottom-info-01">
            <div class="featured-logos-line d-flex no-gutters justify-content-center">
              ...
              <div><img src="<?php echo $this->assets_global; ?>img/featured-bc.png" alt=""></div>
              <div><img src="<?php echo $this->assets_global; ?>img/featured-an.png" alt=""></div>
              <div><img src="<?php echo $this->assets_global; ?>img/featured-n.png" alt=""></div>
              <div><img src="<?php echo $this->assets_global; ?>img/featured-twsj.png" alt=""></div>
            </div>
          </div>
        </section>
