...
class FlowHelper {
  ...
  public function set_signup_steps_data_array($additional_data_array = []) {
    ...
    $data['business_phone'] = ltrim(trim($_POST['business_phone']), '+1');
    ...
    $data['owner_1_phone'] = ltrim(trim($_POST['personal_phone']), '+1');
  ...
  public function set_verify_file_data_array($data = [], $file_info = []) {
  ...
  public function set_file_data_array($data = [], $file_info = []) {
    if(count($data) > 0 && count($file_info) > 0) {
      $data['user_file_name'] = $file_info['file_name'];
      $data['file_base64'] = base64_encode($file_info['file']);
      return $data;
    }
    ...
    $data['file_id'] = trim($_POST['doc_id']);
    $data['file_name'] = trim($_POST['doc_name']);
    $data['user_file_name'] = null;
    $data['file_base64'] = null;
    return $data;
  }
