...
$header_logo = array_key_exists('header_logo', $data) ? $data['header_logo'] : 'img/markup-06/logo.svg';
...
?>
      ...
      <header id="header" class="header-06">
            ...
            <div class="hb-cart col-auto ml-auto">
              <div class="hb-cart-service-selected">
                ...
                <span class="hb-cart-02">
                  <span class="hbc-main">Tasa Base 1.29%</span><br>
                  <span class="hbc-old">2,65%</span>
                </span>
              </div>
