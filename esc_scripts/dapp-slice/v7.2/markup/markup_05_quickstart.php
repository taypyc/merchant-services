                ...
                <form class="form-application application-form-steps" <?php echo $form_continue_attr; ?>>
                  ...
                  <div class="fa-step-item">
                    <div class="block-mb-md text-center">
                      <h4>Empecemos</h4>
                      <p class="sub-header">Cuéntenos sobre su negocio y vea cuánto podría <span class="block-ws-nowrap">ahorrar con Slice</span></p>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-12 col-md-6">
                        <label>Correo electronico de negocios</label>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <p class="field-description">Valor mediana de transaccion de cliente en tu negozio</p>
                      </div>
                    </div>

                    <div class="form-group fg-btn row">
                      <div class="col-12 col-md-6 align-self-center">
                        <p class="fg-btn-description">Al enviar este formulario, acepta los <a href="terms-of-use" target="_blank">Términos de uso</a>, la <a href="privacy-policy" target="_blank">Política de privacidad</a>. <br>Su información es confidencial y segura.</p>
                      </div>
                      <div class="col-12 col-md-6">
