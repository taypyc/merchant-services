                ...
                <form class="form-application application-form-steps" <?php echo $form_continue_attr; ?>>
                  ...
                  <div class="fa-step-item">
                    <div class="block-mb-md text-center">
                      ...
                      <p class="sub-header">Tell us a little about your business and instantly find out if you qualify <span class="block-ws-nowrap text-color-01">for the Lowest Rate of 1.29%!</span></p>
                    </div>
                    ...
                    <div class="form-group fg-btn row">
                      <div class="col-12 col-md-6 align-self-center">
                        <p class="fg-btn-description">By submitting this form, you agree to <a href="https://merchantservicespr.com/privacy-policy" target="_blank">Privacy policy</a>. <br>Your information is confidential and secure.</p>
                      </div>
                      <div class="col-12 col-md-6">
                  ...
                  <div class="fa-step-item">
                    <div class="block-mb-lg">
                      <h4 class="text-center block-mb-01 wrap-br-03">Congratulations, you qualify for the <span class="text-color-01">Lowest Rate of 1.29% Guaranteed!</span></h4>
                      ...
                      <div class="tile-info-divided d-flex no-gutters">
                        ...
                        <div class="tid-item col-4">
                          <div class="tid-item-content">
                            ...
                            <p>By simply completing a few easy steps, we can process your application and schedule delivery and installation of your new devices.</p>
                          </div>
                        </div>
                        ...
                        <div class="tid-item col-4">
                          <div class="tid-item-content">
                            <h6>Start Using!</h6>
                            <p>You're all set! Start processing credit cards with the lowest rates and the latest in technology!</p>
                          </div>
                        </div>
                      </div>
                    </div>
